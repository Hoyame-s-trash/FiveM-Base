...
if not Config.FivemAppeareance then
	...
	function SetupSkin() 
		Config.ServerFramework.TriggerServerCallback("esx_skin:getPlayerSkin", function(_, skin)
	...
	function CheckData()
		Config.ServerFramework.TriggerServerCallback("esx_skin:getPlayerSkin", function(model, skin)
