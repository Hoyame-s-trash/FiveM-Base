...
Config = {
    ...
    Text = {
        ...
        SPRAY_ERRORS = {
            ...
            TOO_FAR = "La surface est trop éloignée",
            INVALID_SURFACE = "Il ne peut pas être pulvérisé sur cette surface",
            AIM = "Diriger le jet vers un mur plat",
        },
        NO_SPRAY_NEARBY = "Il n'y a pas de spray à proximité pour enlever",
        NEED_SPRAY = "Vous n'avez pas de spray à pulvériser",
        WORD_LONG = "Le mot 'Spray' peut comporter au maximum 9 caractères",
        USAGE = "Utilisation : /spray",
        NUI_TEXT = {
            ["text"] = "TEXT",
            ["image"] = "IMAGE",
            ["word-not-allowed"] = "Ce mot n'est pas autorisé !",
            ["color"] = "COULEUR",
            ["spray"] = "PULVÉRISER",
            ["click-to-select"] = "CLIQUEZ POUR SÉLECTIONNER",
            ["cancel"] = "ANNULER",
            ["keybind-spray"] = "Pulvériser",
            ["keybind-change-size"] = "Changer la taille",
            ["keybind-back"] = "Retour",
            ["input-placeholder"] = "Votre texte de graffiti ici",
            ["default-graffiti"] = "GRAFFITI",
            ["save-color"] = "Enregistrer",
        }
    }
}
