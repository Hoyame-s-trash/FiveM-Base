...
$(document).on("keydown", function () {
    switch (event.keyCode) {
        case 27: // ESC
            if (escUsable) {
                $.post("https://cases/closeMenu", JSON.stringify());
                $(".fullBackGround").hide();
                $(".generalSection").hide();
                $(".caseOpeningSection").hide();
                $(".topBar").hide();
        ...
        $(".marketCoinListArea").append(`
            <div class="coinItem">
                ...
                <div class="coinTextArea">
                    ...
                    <div class="buyCoinText">COINS</div>
                </div>
