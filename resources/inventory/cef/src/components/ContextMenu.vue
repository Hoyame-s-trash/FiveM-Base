            ...
            <template v-if="contextMenuStore.store?.invItem">
                ...
                <div class="newtooltip-buttons-content">
                    <button v-if="contextMenuStore.store.invItem.item.data.weaponHash"
                        ...
                        @click.prevent.left="contextMenuStore.disableClose = !contextMenuStore.disableClose">Modify</button>
                    <button @click.prevent.left="Rename">Rename</button>
            ...
            <template v-else-if="contextMenuStore.store?.shopItem">
                ...
                <div class="newtooltip-infos-content">
                    ...
                    <div class="info-entry">
                        ...
                        <div class="answer">${{ contextMenuStore.store.shopItem.item.price }} per count</div>
                    </div>
...
function Rename() {
    if (contextMenuStore.store) {
        ...
        inputStore.open({
            ...
            acceptLabel: 'Accept',
            cancelLabel: 'Cancel',
            description: `Please enter the custom name!`,
...
function Note() {
    if (contextMenuStore.store) {
        ...
        inputStore.open({
            ...
            acceptLabel: 'Accept',
            cancelLabel: 'Cancel',
            description: `Please enter the note which you want to add!`,
            descriptionHtml: true,
            headerLabel: 'Note',
