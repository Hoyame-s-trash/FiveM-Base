...
var AppInput = new Vue({
    ...
    methods: {
        Choose: function(){
            $.post('https://rcore_carnival/inputmethod', JSON.stringify({
                identifier: this.identifier,
                message: this.message,
            }));
        },
        Close: function(){
            $.post('https://rcore_carnival/close', JSON.stringify({
                identifier: this.identifier,
            }));
        },
    },
	...
	window.addEventListener('message', function(event) {
	    ...
	    if(App.visible && !AppInput.visible){
            if (item.type_menu === "enter"){
                $.post('https://rcore_carnival/clickItem', JSON.stringify({
            ...
            if (item.type_menu === "up"){
                ...
                $.post('https://rcore_carnival/selectNew', JSON.stringify({
                    index: App.menu[index].number,
                    identifier: App.identifier,
