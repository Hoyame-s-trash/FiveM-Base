...
-- Weight settings
-- "Inventory.Weight.Divide", qb-core uses weights in grams if you use kilograms change 1000 to 1
-- "Inventory.Weight.MaxPlayerWeight", player max weight limit this "limit can be EXCEEDED" but walk speed will slow down
-- "Inventory.Weight.OverweightMultiplier", when if it exceeds the limit, multiplys with 2, calculation formula ( MaxWeight/(CurrentWeight*MultiplyNumber) )

Inventory.Weight                       = {}
Inventory.Weight.Divide                = 1
...
Inventory.ReloadTime = math.random(4000, 6000)

Inventory.DurabilityBlockedWeapons = {
    "weapon_stungun",
    "weapon_nightstick",
    "weapon_flashlight",
    "weapon_unarmed",
...
Inventory.DurabilityMultiplier = {
	-- Melee
	-- ['weapon_unarmed'] 				 = 0.15,
	['weapon_dagger'] 				 = 0.15,
	['weapon_bat'] 				 	 = 0.15,
...
Inventory.WeaponAttachment = {}
Inventory.WeaponAttachment.Bones = {
...
Inventory.WeaponAttachment.Weapons = { 
    { 
        name = 'weapon_pistol', 
        components = { 
...
Inventory.Weapons = Inventory.WeaponAttachment.Weapons
Inventory.WeaponAttachment.Ammo = Inventory.WeaponList
...
Inventory.Functions.Server = {
    ...
    GetPlayer                       = function ( source )
        local EasyFramework = Inventory.ServerFramework
        return EasyFramework.Functions.GetPlayer(source)
    end,

    GetName                         = function ( source )
        return Inventory.Functions.Server.GetPlayer( source ).PlayerData.charinfo
    end,

    GetIdentifier                   = function(source)
        if Inventory.Functions.Server.GetPlayer(source) == nil then
            ...
            local identifier = Inventory.Functions.Server.GetPlayer(source).PlayerData.citizenid
            return identifier
        end
    end,
    ...
    GetPlayerFromUniqueValue        = function(id)
        local EasyFramework = Inventory.ServerFramework
        return EasyFramework.Functions.GetPlayerByCitizenId(id)
    end,
}
Inventory.VehiclesInventory = {}
Inventory.VehiclesInventory.Models = {
    ["ASEA"] = {
        ["glovebox"] = "hhm3eomwf3cygww8e6kcgpt6",
    }
}
Inventory.VehiclesInventory.Classes = {
    [0] = {
...
Inventory.ServerFramework = Inventory.Functions.Server.GetFramework()
