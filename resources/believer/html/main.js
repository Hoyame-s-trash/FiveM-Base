...
function StartProgress(itemD) {
    ...
    $(`#search-icon-${containerParentID}`).html(`   <div class="loader-search-icon"></div>  <span class="searching-text">Recherche</span> <div class="button-cancel-search">x</div><span class="searching-time-passed"><label id="minutes">0</label>:<label id="seconds">00</label></span>`)
