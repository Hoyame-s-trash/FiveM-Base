...
Config.Queue            = 3             -- No. of notifications to show before queueing
...
Config.Pictures = {
    ...
    -- Customs
    CHAR_SCRATCH                     = "Char_scratch.png",
    CHAR_CANNABIS                    = "Char_cannabis.png",

    NOTIF_EGGHUNT                    = "notif_egghunt.jpg",
    NOTIF_PUMPKIN                    = "notif_pumpkin.jpg",
