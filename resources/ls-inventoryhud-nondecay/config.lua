...
Config.Notify = function(message, type) 
    Config.ServerFramework.Functions.Notify(message, type)
end

Config.Version = "1.0.3" -- DO NOT CHANGE IT WILL BE UPDATED!

Config.Debug = true -- IF YOU WANT TO STABLE VERSION OF INVENTORY DO NOT MAKE TRUE!

Config.CheckInventoryEveryStart = true
...
Config.Weight.OverweightDisableJump = 1.2
