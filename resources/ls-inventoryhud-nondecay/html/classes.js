...
function ReadyItems(data, remember) {
            ...
            if (newItem.isSearched == undefined) {
                ...
                if (!isInventoryPlayer(newItem)) {
                    if (remember != undefined) {
                        if (remember[newItem._id] != undefined) {
                            if (newItem._parent == remember[newItem._id]._parent && newItem.slotId == remember[newItem._id].slotId)
                                newItem.isSearched = true;
                            else
                                newItem.isSearched = false;
                        } else 
