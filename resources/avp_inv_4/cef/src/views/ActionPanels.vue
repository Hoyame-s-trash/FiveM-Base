<template>
    <div class="action-panels-container">
        ...
        <div :ref="drop_Throw" class="panel throw">Throw</div>
        <div :ref="drop_Use" class="panel use">Use</div>
        <div :ref="drop_Give" class="panel give">Give</div>
    </div>
</template>
...
.action-panels-container {
    ...
    .panel {
        ...
        &.use {
            height: 4vw;
            width: 7vw;
            border-bottom: 0.2vw groove orange;
        }
